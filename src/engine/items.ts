...
export interface ItemDef {
  ...
  /** food need restored when eaten (food items only) */
  food?: number;
...
export const ITEMS: Record<string, ItemDef> = {
  ...
  roots: { id: 'roots', name: 'Wild Roots', kind: 'food', food: 22, value: 2, blurb: 'Dug from the hedgerow. Bitter.' },
  fish: { id: 'fish', name: 'River Fish', kind: 'food', food: 34, value: 8, blurb: 'Fresh-caught and slippery.' },
  game: { id: 'game', name: 'Snared Game', kind: 'food', food: 46, value: 14, blurb: 'A rabbit or hare, cleanly taken.' },
  herbs: { id: 'herbs', name: 'Healing Herbs', kind: 'herb', value: 10, blurb: 'Feverfew and comfrey — a poor man\'s medicine.' },
  firewood: { id: 'firewood', name: 'Bundle of Firewood', kind: 'goods', value: 5, blurb: 'Deadfall gathered from the wood.' },
  scrap: { id: 'scrap', name: 'Salvaged Scrap', kind: 'goods', value: 7, blurb: 'Bent nails, rags, a cracked buckle — worth a coin to someone.' },
};
